 ...
 100  continue
   ...
   subroutine runge(x1,y1,p1,left,x0,y0,p0,reltpos0,reltpos1,deltat,numit,jump,&
      ...
      ! update position and keep them
        ...
        !print*, "check deltax ", deltay, cos(y0), deltay*cos(y0*pi/180)
      ...
      !print*, "first check (x1,y1,p1): ",x1,y1,p1   ! checckkkkk
      ...
      print*, "final (x1,y1,p1): ",x1,y1,p1   ! checckkkkk
