    ...
    do i = ntrace1, 1, -1
        ...
        trajectory_loop2: do j = ista,iend
            ...
            elseif  ( varsint(i+ncol).eq.'RELVORT' ) then
                ...
                call calc_DFDX (tmp2, traint(j,k,ind3),traint(j,k,ind4),traint(j,k,ind5) )
            ...
            elseif  ( varsint(i+ncol).eq.'DEF' ) then
                ...
                call calc_DFDY (tmp3, traint(j,k,ind6),traint(j,k,ind7) )
                ...
                call calc_DFDX(tmp4,traint(j,k,ind8),traint(j,k,ind9),traint(j,k,ind5) )
            ...
            elseif  ( varsint(i+ncol).eq.'PV' ) then
                ...
                call calc_DTHDX (dthdx, traint(j,k,ind17),traint(j,k,ind18),traint(j,k,ind11),traint(j,k,ind5) )
                ...
                call calc_DTHDY (dthdy, traint(j,k,ind19),traint(j,k,ind20),traint(j,k,ind11) )
