...
'define divbl=(hdivg(u10,v10)+d(lev=950))*(msl-95000.)/2.+((d(lev=950)+d(lev=850))/2.+d(lev=925)+d(lev=900)+d(lev=875))*2500.'
...
'set strsiz 0.25'
'draw string 1 8 DIV_BL & DP 30/07/17 00UTC'

*'gxprint filename.png x1024 y768'
'printim DIVBL_DP_30-07-17_00.png x1024 y768'  
