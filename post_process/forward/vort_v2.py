...
ref_lev = np.array([1000., 900., 850., 800., 750., 700.,650.,600., 500.,400., 300.,200.])
...
rvor = np.full([nlev,nlat,nlon],np.nan)
...
relvort = ncfile.createVariable('relvort',np.float64,('level','latitude','longitude'))
